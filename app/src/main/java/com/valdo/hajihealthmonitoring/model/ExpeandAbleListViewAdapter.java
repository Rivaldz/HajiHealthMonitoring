...
public class ExpeandAbleListViewAdapter extends BaseExpandableListAdapter {

    private Context context;
    private List<String> chapterList;
    private HashMap<String, List<String>> topicsList;

    public ExpeandAbleListViewAdapter(Context context, List<String> chapterList, HashMap<String, List<String>> topicsList) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView topicTv = convertView.findViewById(R.id.chapter_tv);
